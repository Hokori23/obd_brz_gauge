...
{
    ui_oil_pressure_layout_t layout;
    ui_oil_pressure_layout_get(&layout);
    ...
    ui_LabelOilPressureText = lv_label_create(parent);
    lv_label_set_text(ui_LabelOilPressureText, "--.-");
    lv_obj_set_style_text_font(ui_LabelOilPressureText, ui_font_typoder(56), LV_PART_MAIN);
    lv_obj_set_style_text_color(ui_LabelOilPressureText, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    lv_obj_set_width(ui_LabelOilPressureText, layout.value_width);
    lv_obj_set_style_text_align(ui_LabelOilPressureText, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN);
    lv_obj_align(ui_LabelOilPressureText, LV_ALIGN_CENTER, layout.value_x, layout.value_y);
    ...
    lv_obj_set_size(ui_ChartOilPressure, layout.trend_width, layout.trend_height);
    ...
    lv_obj_set_style_line_width(ui_ChartOilPressure, layout.chart_line_width, LV_PART_ITEMS | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_line_width(ui_ChartOilPressure, layout.tick_line_width, LV_PART_TICKS | LV_STATE_DEFAULT);
...
void ui_ScreenPageOilPressure_screen_init(void)
{
    ...
    ui_round_screen_apply_base(ui_ScreenPageOilPressure, lv_color_hex(0x000000));
    ui_round_shell_create_ring(ui_ScreenPageOilPressure, &layout.shell);
